  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (!productIdSaved[data[i].product_id]) {
      ...
      const jsonMongo = {
        ...
        results: [
          {
            ...
            // recommend: (data[i].recommend === "TRUE" || data[i].recommend === "true"),
            ...
            // reported: (data[i].reported === "TRUE" || data[i].reported === "true")
          }
        ],
        ratings: {
        ...
        recommended: {
          false: data[i].recommend === "false" ? '1' : '0',
          true: data[i].recommend === "true" ? '1' : '0'
          // false: data[i].recommend === "FALSE" ? '1' : '0',
          // true: data[i].recommend === "TRUE" ? '1' : '0'
        },
        characteristics: {}
